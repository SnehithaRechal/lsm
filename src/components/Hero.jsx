  ...
  return (
    <section className="text-gray-600 body-font">
        ...
        <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            <img className="object-cover object-center rounded" alt="hero" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSe1mQobPMKWYYDxJtVhZFXjpw1L3tBNihDD7fYyJ5uBo_gKYHHNztXMvoxEiDgLDWBHS8&usqp=CAU" /><br>
            </br>
        </div>
        </div>
    </section>
